...
function Formulario({ hotelId, onSubmit }) {
  ...
  const validate = () => {
    ...
    if (!hotelData.precoDiaria || isNaN(parseFloat(hotelData.precoDiaria.replace(".", "").replace(",", "."))) || parseFloat(hotelData.precoDiaria.replace(".", "").replace(",", ".")) <= 0) {
