  ...
  useEffect(() => {
    const hoteis = [
      ...
      },
      {
        ...
        descricao:
          "Charmosa pousada em estilo colonial, localizada no centro histórico de Tiradentes.",
        imagens: [
      ...
      },
      {
        ...
        descricao:
          "Resort sustentável próximo às Cataratas do Iguaçu, com atividades de ecoturismo e lazer.",
        imagens: [
      ...
      },
      {
        ...
        cidade: "Curitiba - PR",
        descricao:
          "Hotel de luxo no centro de Curitiba, com acomodações modernas e serviços de alto padrão.",
        imagens: [
